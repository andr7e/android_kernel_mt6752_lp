...
struct mtp_ext_prop_desc_property {
	...
	__u8	bPropertyName[8];		
	__le32	dwPropertyDataLength;
	__u8	bPropertyData[22];		
...
static int mtp_send_devicereset_event(struct mtp_dev *dev)
{
    ...
    char buffer[12]={0x0C, 0x0, 0x0, 0x0, 0x4, 0x0, 0xb, 0x40, 0x0, 0x0, 0x0, 0x0};   
...
static int mtp_bind_config(struct usb_configuration *c, bool ptp_config)
{
	...
	if (ptp_config || fsg_mode || !mac_mtp_mode) {
