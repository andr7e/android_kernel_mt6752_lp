...
extern LCM_DRIVER r63423_wqhd_tianma_lcm_drv;
extern LCM_DRIVER r63423_wqhd_jdi_lcm_drv;
extern LCM_DRIVER r63423_wqhd_jdi_lcm_55_drv;
extern LCM_DRIVER r63315_fhd_tianma_lcm_drv;
extern LCM_DRIVER r63423_wqhd_sharp_lcm_drv;
extern LCM_DRIVER r63319_wqhd_tianma_ironmantb_2k_vdo;
extern LCM_DRIVER nt35596_fhd_truly_lcm_drv;
...
extern LCM_DRIVER sh1368_hd720_dsi_vdo_edo_lcm_drv;
extern LCM_DRIVER nt35596_fhd_dsi_vdo_truly_ktd3121_lcm_drv;
extern LCM_DRIVER hx8394d_hd720_dsi_vdo_truly_ktd3121_lcm_drv;
...
#if defined(R63423_WQHD_JDI_2K_CMD)
    &r63423_wqhd_jdi_lcm_drv,
#endif

#if defined(R63423_WQHD_JDI_2K_CMD_55)
    &r63423_wqhd_jdi_lcm_55_drv,
#endif

#if defined(R63423_WQHD_TIANMA_2K_VDO)
    &r63423_wqhd_tianma_lcm_drv,
#endif

#if defined(R63315_TIANMA_FHD_VDO)
	&r63315_fhd_tianma_lcm_drv,
#endif

#if defined(R63423_WQHD_SHARP_2K_CMD)
	&r63423_wqhd_sharp_lcm_drv,
#endif

#if defined(NT35596_FHD_TRULY_VDO)
	&nt35596_fhd_truly_lcm_drv,
#endif

#if defined(R63319_WQHD_TIANMA_IRONMANTB_2K_VDO)
    &r63319_wqhd_tianma_ironmantb_lcm_drv,
#endif
...
#if defined(SH1368_HD720_DSI_VDO_EDO)
	&sh1368_hd720_dsi_vdo_edo_lcm_drv,
#endif

#if defined(NT35596_FHD_DSI_VDO_TRULY_KTD3121)
	&nt35596_fhd_dsi_vdo_truly_ktd3121_lcm_drv,
#endif

#if defined(HX8394D_HD720_DSI_VDO_TRULY_KTD3121)
	&hx8394d_hd720_dsi_vdo_truly_ktd3121_lcm_drv,
#endif
...
#if defined(GPIO_DISP_ID0_PIN) && defined(GPIO_DISP_ID1_PIN)
#ifdef BUILD_LK
...
{
    static unsigned char lcd_id_pins_value = 0xFF;
    LCD_DEBUG("GPIO ID0 and ID1 undefined\n");
    lcd_id_pins_value = LCD_HW_ID_STATUS_ERROR | (LCD_HW_ID_STATUS_ERROR << 2);
    return lcd_id_pins_value;
}
#endif
