...
static int TPS65132_write_byte(kal_uint8 addr, kal_uint8 value)
{
	...
	if(ret_code)
		LCD_LOG("[LK]nt35596----tps6132----addr=%0x--i2c write error----\n",addr);
	else
		LCD_LOG("[LK]nt35596----tps6132----addr=%0x--i2c write success----\n",addr);
...
static int tps65132_write_bytes(unsigned char addr, unsigned char value)
{
	...
	if(ret < 0)
		LCD_LOG("[KERNEL]nt35596----tps6132---addr=%0x-- i2c write error-----\n",addr);
	else
		LCD_LOG("[KERNEL]nt35596----tps6132---addr=%0x-- i2c write success-----\n",addr);
	if(ret<0)
		return ret ;
}
