...
#define force_usb11_en_fs_ls_rcv 0x04 
#define force_usb11_en_fs_ls_tx 0x02 
#define RG_USB11_EN_FS_LS_RCV 0x04 
#define RG_USB11_EN_FS_LS_TX 0x02 
...
#define RG_USB11_AVALID 0x04 
#define RG_USB11_BVALID 0x08 
#define RG_USB11_SESSEND 0x10 
#define RG_USB11_VBUSVALID 0x20 
#define force_usb11_avalid 0x04 
#define force_usb11_bvalid 0x08 
#define force_usb11_sessend 0x10 
#define force_usb11_vbusvalid 0x20 

#ifdef CONFIG_MTK_USBFSH
	extern struct musbfsh  *g_musbfsh;
	#define USB11PHY_READ32(offset)         __raw_readl((void __iomem *)(((unsigned long)g_musbfsh->phy_base)+0x900+offset))
	#define USB11PHY_READ8(offset)          __raw_readb((void __iomem *)(((unsigned long)g_musbfsh->phy_base)+0x900+offset))
	#define USB11PHY_WRITE8(offset, value)  __raw_writeb(value, (void __iomem *)(((unsigned long)g_musbfsh->phy_base)+0x900+offset))
#else
