		      ...
		      struct cfg80211_scan_request *request)
{
    ...
    DBGLOG(SCN, INFO, ("mtk_cfg80211_scan IO start \n" ));
			      ...
			      IN struct cfg80211_sched_scan_request *request)
{
    ...
    DBGLOG(SCN, INFO, ("mtk_cfg80211_sched_scan_start IO start \n" ));
    ...
    DBGLOG(SCN, INFO, ("mtk_cfg80211_sched_scan_start IO done \n" ));
...
int mtk_cfg80211_sched_scan_stop(IN struct wiphy *wiphy, IN struct net_device *ndev)
{
    ...
    DBGLOG(SCN, INFO, ("mtk_cfg80211_sched_scan_stop IO start \n" ));

	rStatus = kalIoctl(prGlueInfo,
			   wlanoidSetStopSchedScan, NULL, 0, FALSE, FALSE, TRUE, &u4BufLen);

    DBGLOG(SCN, INFO, ("mtk_cfg80211_sched_scan_stop IO done \n" ));
