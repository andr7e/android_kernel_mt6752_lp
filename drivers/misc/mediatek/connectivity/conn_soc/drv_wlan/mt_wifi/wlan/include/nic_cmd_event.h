...
typedef enum _ENUM_CMD_ID_T {
    CMD_ID_TEST_MODE = 1,               
    CMD_ID_RESET_REQUEST,               
    CMD_ID_BUILD_CONNECTION,            
    CMD_ID_SCAN_REQ_V2,                 
    ...
    CMD_ID_SEND_ADDBA_RSP,              
    CMD_ID_WAPI_MODE,                   
    CMD_ID_WAPI_ASSOC_INFO,             
...
typedef enum _ENUM_EVENT_ID_T {
    EVENT_ID_CMD_RESULT = 1,            
    EVENT_ID_NIC_CAPABILITY,            
    EVENT_ID_CONNECTION_STATUS,         
    EVENT_ID_SCAN_RESULT,               
    ...
    EVENT_ID_RX_ADDBA,                  
    EVENT_ID_RX_DELBA,                  
    EVENT_ID_ACTIVATE_STA_REC_T,        
    EVENT_ID_DEACTIVATE_STA_REC_T,      
    EVENT_ID_SCAN_DONE,                 
    EVENT_ID_RX_FLUSH,                  
    EVENT_ID_TX_DONE,                   
    EVENT_ID_CH_PRIVILEGE,              
    EVENT_ID_BSS_ABSENCE_PRESENCE = 0x19,  
    ...
    EVENT_ID_UPDATE_BWCS_STATUS = 0x25,         
    EVENT_ID_UPDATE_BCM_DEBUG,                    
#endif
    EVENT_ID_RX_ERR,
    EVENT_ID_DUMP_MEM,
    EVENT_ID_STA_STATISTICS= 0x29,            
