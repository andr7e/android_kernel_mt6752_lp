...
#define DECLARE_REG_RANGE(base, name) case base: return #name;
	switch (addr_base_and_page) {
		DECLARE_REG_RANGE(0x14001000, MDP);	
		DECLARE_REG_RANGE(0x14002000, MDP);	
		DECLARE_REG_RANGE(0x14003000, MDP);	
		DECLARE_REG_RANGE(0x14004000, MDP);	
		DECLARE_REG_RANGE(0x14005000, MDP);	
		DECLARE_REG_RANGE(0x14006000, MDP);	

		DECLARE_REG_RANGE(0x1400C000, COLOR);	
		DECLARE_REG_RANGE(0x1400D000, CCORR);	
		DECLARE_REG_RANGE(0x14007000, OVL0);	
		DECLARE_REG_RANGE(0x14008000, OVL1);	
		DECLARE_REG_RANGE(0x1400E000, AAL);	
		DECLARE_REG_RANGE(0x1400F000, AAL);	
		DECLARE_REG_RANGE(0x17002FFF, VENC);	
		DECLARE_REG_RANGE(0x17003FFF, JPGENC);	
		DECLARE_REG_RANGE(0x17004FFF, JPGDEC);	
	}
