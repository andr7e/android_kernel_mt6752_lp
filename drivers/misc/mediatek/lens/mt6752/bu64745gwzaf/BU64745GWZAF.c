...
static void    func_INITIALIZE( void ){
    ...
    I2C_write_FBAF(     0x37, 0x0008 );    

    I2C_write_FBAF(     0x25, 0x0003 );    
    I2C_write_FBAF(     0x26, 0x0100 );    
    I2C_write_FBAF(     0x27, 0x0200 );    
    I2C_write_FBAF(     0x28, 0x0200 );    
    I2C_write_FBAF(     0x29, 0x0200 );    

    I2C_write_FBAF(     0x24, 0x40F0 );    
    I2C_write_FBAF(     0x22, 0xC2F8 );    
    I2C_write_FBAF(     0x23, 0x0311 );    

    
    
    
     I2C_func_CEF_WRITE( 0x27, 0x0000 );    
    
     I2C_func_CEF_WRITE( 0x20, 0x0000 );    
    I2C_func_CEF_WRITE( 0x25, 0xE000 );    
    I2C_func_CEF_WRITE( 0x21, 0xC000 );    

    I2C_func_CEF_WRITE( 0x2D, 0x8800 );    
    I2C_func_CEF_WRITE( 0x00, 0x7FFF );    
    I2C_func_CEF_WRITE( 0x01, 0x5000 );    
    I2C_func_CEF_WRITE( 0x02, 0x4000 );    
    I2C_func_CEF_WRITE( 0x03, 0x4000 );    
    I2C_func_CEF_WRITE( 0x08, 0x0000 );    
    I2C_func_CEF_WRITE( 0x09, 0x6000 );    
    I2C_func_CEF_WRITE( 0x0A, 0x4000 );    
    I2C_func_CEF_WRITE( 0x0B, 0x4000 );    
    I2C_func_CEF_WRITE( 0x10, 0x0000 );    
    I2C_func_CEF_WRITE( 0x11, 0x7FFE );    
    I2C_func_CEF_WRITE( 0x12, 0x4000 );    
    I2C_func_CEF_WRITE( 0x13, 0xD000 );    

    
    I2C_func_CEF_WRITE( 0x38, 0x1000 );    

     I2C_func_CEF_WRITE( 0x27, 0x0000 );    
     I2C_func_CEF_WRITE( 0x2B, 0x0000 );    
     I2C_func_CEF_WRITE( 0x04, 0x0000 );    
     I2C_func_CEF_WRITE( 0x0C, 0x0000 );    
     I2C_func_CEF_WRITE( 0x14, 0x0000 );    
     I2C_func_CEF_WRITE( 0x1D, 0x0000 );    
     I2C_func_CEF_WRITE( 0x1E, 0x0000 );    
    I2C_func_CEF_WRITE( 0x2A, 0x0000 );    

    I2C_func_CEF_WRITE( 0x18, 0x7FFF );    
     I2C_func_CEF_WRITE( 0x19, 0x0000 );    
     I2C_func_CEF_WRITE( 0x1A, 0x0000 );    
     I2C_func_CEF_WRITE( 0x1B, 0x0000 );    
     I2C_func_CEF_WRITE( 0x1C, 0x0000 );    

    
    I2C_func_CEF_WRITE( 0x0E, 0x1000 );    

    
     I2C_func_CEF_WRITE( 0x16, 0x0000 );    
    I2C_func_CEF_WRITE( 0x17, 0x36E2 );    
    I2C_func_CEF_WRITE( 0x29, 0x4000 );    

     I2C_func_CEF_WRITE( 0x31, 0x0000 );    
    I2C_func_CEF_WRITE( 0x32, 0x0800 );    

     I2C_func_CEF_WRITE( 0x06, 0x0000 );    
     I2C_func_CEF_WRITE( 0x07, 0x0000 );    

    
    I2C_func_CEF_WRITE( 0x34, 0x0002 );    
    I2C_func_CEF_WRITE( 0x35, 0x0002 );    
    I2C_func_CEF_WRITE( 0x37, 0x0008 );    
    I2C_func_CEF_WRITE( 0x36, 0x0002 );    
}
...
static CL_BOOL        func_ReLOAD_FACT_DATA( void ){
    ...
    dat_L = I2C_func_NVL__READ( 0x40 );    

    if    ( ( dat_L == 0xFF ) || ( dat_L == 0x00 ) ){
        return -1;
    }

    dat_L      = I2C_func_NVL__READ( 0x41 );    
    gl_AMPGAIN = dat_L << 8;
    _CHG_H_GAIN( gl_AMPGAIN );                    

    dat_L      = I2C_func_NVL__READ( 0x42 );    
    gl_PREOFST = dat_L << 2;
    I2C_write_FBAF( 0x27, gl_PREOFST );            

    dat_L = I2C_func_NVL__READ( 0x43 );            
    gl_POSTOFS = dat_L << 2;
    I2C_write_FBAF( 0x28, gl_POSTOFS);            
                                                
    dat_H = I2C_func_NVL__READ( 0x44 );            
    dat_L = I2C_func_NVL__READ( 0x45 );            
    gl_HOFS = ( dat_H << 8 ) | dat_L;
    I2C_func_CEF_WRITE( 0x20, gl_HOFS );        
                                                
    dat_H = I2C_func_NVL__READ( 0x46 );            
    dat_L = I2C_func_NVL__READ( 0x47 );            
    gl_KgHG = ( dat_H << 8 ) | dat_L;
    I2C_func_CEF_WRITE( 0x21, gl_KgHG   );        
                                                
    dat_H = I2C_func_NVL__READ( 0x48 );            
    dat_L = I2C_func_NVL__READ( 0x49 );            
    gl_KgLPG = ( dat_H << 8 ) | dat_L;
    I2C_func_CEF_WRITE( 0x25, gl_KgLPG  );        
                                                
    dat_H = I2C_func_NVL__READ( 0x4A );            
    dat_L = I2C_func_NVL__READ( 0x4B );            
    gl_Kf0A = ( dat_H << 8 ) | dat_L;
    I2C_func_CEF_WRITE( 0x17, gl_Kf0A );        
                                                
    dat_H = I2C_func_NVL__READ( 0x4C );            
    dat_L = I2C_func_NVL__READ( 0x4D );            
    gl_CUROFS = ( dat_H << 8 ) | dat_L;
    I2C_func_CEF_WRITE( 0x16, gl_CUROFS );

    dat_H = I2C_func_NVL__READ( 0x4E );            
    dat_L = I2C_func_NVL__READ( 0x4F );            
