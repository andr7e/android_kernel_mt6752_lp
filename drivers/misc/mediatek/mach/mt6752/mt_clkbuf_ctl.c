...
#define BSI_CW_CNT           30  
#define BSI_CLK_HALF_PERIOD  1   
#define BSI_CLK_PERIOD       (BSI_CLK_HALF_PERIOD<<1)   

#define BSI_DATA_BIT         0   
#define BSI_READ_BIT         0   
...
static void clk_buf_Send_BSI_CW(CLK_BUF_SWCTRL_STATUS_T *status)
{
	...
	SET_GPIO_DOUT( GPIO_OUT_ZERO,	GPIO_OUT_ZERO, GPIO_OUT_ZERO, GPIO_OUT_ZERO, GPIO_OUT_ZERO ); 
	...
	SET_GPIO_DOUT( GPIO_OUT_ZERO,  GPIO_OUT_ZERO, GPIO_OUT_ZERO, GPIO_OUT_ZERO, GPIO_OUT_ZERO ); 
	SET_GPIO_DOUT( GPIO_OUT_ONE, GPIO_OUT_ZERO, GPIO_OUT_ZERO, GPIO_OUT_ZERO, GPIO_OUT_ZERO ); 
