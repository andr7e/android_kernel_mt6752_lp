...
#define __DEBUG_NAND		1			

#define DBG_EVT_NONE		0x00000000	
#define DBG_EVT_INIT		0x00000001	
#define DBG_EVT_VERIFY		0x00000002	
#define DBG_EVT_PERFORMANCE	0x00000004	
#define DBG_EVT_READ		0x00000008	
#define DBG_EVT_WRITE		0x00000010	
#define DBG_EVT_ERASE		0x00000020	
#define DBG_EVT_BADBLOCK	0x00000040	
#define DBG_EVT_POWERCTL	0x00000080	
