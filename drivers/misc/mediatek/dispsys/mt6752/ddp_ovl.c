		...
		void *handle)
{
    ...
    switch(yuv_range)
    {
        case 0: color_matrix = 4; break; 
        case 1: color_matrix = 6; break; 
        case 2: color_matrix = 7; break; 
        default: 
...
#ifdef CONFIG_MTK_LCM_PHYSICAL_ROTATION_HW
    value = value | (REG_FLD_VAL((L_CON_FLD_VIRTICAL_FLIP), 1) | REG_FLD_VAL((L_CON_FLD_HORI_FLIP), 1));
#endif
			...
			void *handle)
{
    ...
    if(module==DISP_MODULE_OVL0 && 
      (ovl_get_status()==DDP_OVL1_STATUS_PRIMARY || ovl_get_status()==DDP_OVL1_STATUS_SUB_REQUESTING))  
    {
        layer_min = 4;
        layer_max = 8;
    }
