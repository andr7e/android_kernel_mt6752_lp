...
typedef struct
{
    DSI_START_REG				DSI_START;				
    DSI_STATUS_REG  			DSI_STA;				
    DSI_INT_ENABLE_REG		DSI_INTEN;				
    DSI_INT_STATUS_REG		DSI_INTSTA;			
    DSI_COM_CTRL_REG			DSI_COM_CTRL;			
    DSI_MODE_CTRL_REG		DSI_MODE_CTRL;		
    DSI_TXRX_CTRL_REG			DSI_TXRX_CTRL;		
    DSI_PSCTRL_REG			DSI_PSCTRL;			
    DSI_VSA_NL_REG			DSI_VSA_NL;			
    DSI_VBP_NL_REG			DSI_VBP_NL;			
    DSI_VFP_NL_REG			DSI_VFP_NL;			
    DSI_VACT_NL_REG			DSI_VACT_NL;			
    UINT32                  			rsv_30[8];               		
    DSI_HSA_WC_REG			DSI_HSA_WC;			
    DSI_HBP_WC_REG			DSI_HBP_WC;			
    DSI_HFP_WC_REG			DSI_HFP_WC;			
    DSI_BLLP_WC_REG			DSI_BLLP_WC;			

    DSI_CMDQ_CTRL_REG		DSI_CMDQ_SIZE;		
    UINT32                  			DSI_HSTX_CKL_WC;    	
    UINT32                  			DSI_HSTX_CKL_WC_AUTO_RESULT;    	
    UINT32					rsv_006C[2];      			
    DSI_RX_DATA_REG			DSI_RX_DATA0;			
    DSI_RX_DATA_REG			DSI_RX_DATA1;			
    DSI_RX_DATA_REG			DSI_RX_DATA2;			
    DSI_RX_DATA_REG			DSI_RX_DATA3;			
    DSI_RACK_REG				DSI_RACK;				
    DSI_TRIG_STA_REG			DSI_TRIG_STA;			
    UINT32   	        			rsv_008C;      			
    DSI_MEM_CONTI_REG		DSI_MEM_CONTI;		
    DSI_FRM_BC_REG			DSI_FRM_BC;			
    DSI_3D_CON_REG			DSI_3D_CON;			
    UINT32   	        	rsv_009C;           
    DSI_TIME_CON0_REG       DSI_TIME_CON0;      
    DSI_TIME_CON1_REG       DSI_TIME_CON1;      

    UINT32   	        	rsv_00A8[22];     	
    UINT32					DSI_PHY_PCPAT;		

    DSI_PHY_LCCON_REG		DSI_PHY_LCCON;		
    DSI_PHY_LD0CON_REG		DSI_PHY_LD0CON;		
    UINT32   	        			rsv_010C;      			
    DSI_PHY_TIMCON0_REG		DSI_PHY_TIMECON0;	
    DSI_PHY_TIMCON1_REG		DSI_PHY_TIMECON1;	
    DSI_PHY_TIMCON2_REG		DSI_PHY_TIMECON2;	
    DSI_PHY_TIMCON3_REG		DSI_PHY_TIMECON3;	
    DSI_PHY_TIMCON4_REG		DSI_PHY_TIMECON4;	
    UINT32   	        			rsv_0124[3];      			
    DSI_VM_CMD_CON_REG      	DSI_VM_CMD_CON;		
    UINT32                  			DSI_VM_CMD_DATA0;    	
    UINT32                  			DSI_VM_CMD_DATA4;    	
    UINT32                  			DSI_VM_CMD_DATA8;    	
    UINT32                  			DSI_VM_CMD_DATAC;    	
    DSI_CKSM_OUT_REG			DSI_CKSM_OUT;			
    DSI_STATE_DBG0_REG		DSI_STATE_DBG0;		
    DSI_STATE_DBG1_REG		DSI_STATE_DBG1;		
    DSI_STATE_DBG2_REG		DSI_STATE_DBG2;		
    DSI_STATE_DBG3_REG		DSI_STATE_DBG3;		
    DSI_STATE_DBG4_REG		DSI_STATE_DBG4;		
    DSI_STATE_DBG5_REG		DSI_STATE_DBG5;		
    DSI_STATE_DBG6_REG		DSI_STATE_DBG6;		
    DSI_STATE_DBG7_REG		DSI_STATE_DBG7;		
    DSI_STATE_DBG8_REG		DSI_STATE_DBG8;		
    DSI_STATE_DBG9_REG		DSI_STATE_DBG9;		
    DSI_DEBUG_SEL_REG			DSI_DEBUG_SEL;		
    UINT32    					rsv174;                        		
    UINT32    					DSI_BIST_PATTERN;                  	
    DSI_BIST_CON_REG 			DSI_BIST_CON;                          	
...
typedef struct
{
    MIPITX_DSI_CON_REG				MIPITX_DSI_CON;				
    MIPITX_DSI_CLOCK_LANE_REG			MIPITX_DSI_CLOCK_LANE;		
    MIPITX_DSI_DATA_LANE0_REG			MIPITX_DSI_DATA_LANE0;		
    MIPITX_DSI_DATA_LANE1_REG			MIPITX_DSI_DATA_LANE1;		
    MIPITX_DSI_DATA_LANE2_REG			MIPITX_DSI_DATA_LANE2;		
    MIPITX_DSI_DATA_LANE3_REG			MIPITX_DSI_DATA_LANE3;		
    UINT32                  					rsv_18[10];               				

    MIPITX_DSI_TOP_CON_REG			MIPITX_DSI_TOP_CON;			
    MIPITX_DSI_BG_CON_REG				MIPITX_DSI_BG_CON;			
    UINT32                  					rsv_48[2];						
    MIPITX_DSI_PLL_CON0_REG			MIPITX_DSI_PLL_CON0;			
    MIPITX_DSI_PLL_CON1_REG			MIPITX_DSI_PLL_CON1;			
    MIPITX_DSI_PLL_CON2_REG			MIPITX_DSI_PLL_CON2;			
    MIPITX_DSI_PLL_CON3_REG			MIPITX_DSI_PLL_CON3;			
    MIPITX_DSI_PLL_CHG_REG			MIPITX_DSI_PLL_CHG;			
    MIPITX_DSI_PLL_TOP_REG				MIPITX_DSI_PLL_TOP;			
    MIPITX_DSI_PLL_PWR_REG			MIPITX_DSI_PLL_PWR;			
    UINT32                  					rsv_6C;               					
    MIPITX_DSI_RGS_REG				MIPITX_DSI_RGS;				
    MIPITX_DSI_GPI_EN_REG				MIPITX_DSI_GPI_EN;			
    MIPITX_DSI_GPI_PULL_REG			MIPITX_DSI_GPI_PULL;			
    MIPITX_DSI_PHY_SEL_REG				MIPITX_DSI_PHY_SEL;			

    MIPITX_DSI_SW_CTRL_REG			MIPITX_DSI_SW_CTRL_EN;		
    MIPITX_DSI_SW_CTRL_CON0_REG		MIPITX_DSI_SW_CTRL_CON0;	
    MIPITX_DSI_SW_CTRL_CON1_REG		MIPITX_DSI_SW_CTRL_CON1;	
    MIPITX_DSI_SW_CTRL_CON2_REG		MIPITX_DSI_SW_CTRL_CON2;	
    MIPITX_DSI_DBG_CON_REG			MIPITX_DSI_DBG_CON;			
    UINT32							MIPITX_DSI_DBG_OUT;			
    MIPITX_DSI_APB_ASYNC_STA_REG		MIPITX_DSI_APB_ASYNC_STA;	
...
#define DDP_REG_BASE_DISP_OVL0    OVL0_BASE         
#define DDP_REG_BASE_DISP_OVL1    OVL1_BASE         
#define DDP_REG_BASE_DISP_RDMA0   DISP_RDMA0_BASE   
#define DDP_REG_BASE_DISP_RDMA1   DISP_RDMA1_BASE   
#define DDP_REG_BASE_DISP_RDMA2   DISP_RDMA2_BASE   
#define DDP_REG_BASE_DISP_WDMA0   DISP_WDMA0_BASE   
#define DDP_REG_BASE_DISP_WDMA1   DISP_WDMA1_BASE   
#define DDP_REG_BASE_DISP_COLOR0  COLOR0_BASE       
#define DDP_REG_BASE_DISP_COLOR1  COLOR1_BASE       
#define DDP_REG_BASE_DISP_AAL     DISP_AAL_BASE     
#define DDP_REG_BASE_DISP_GAMMA   DISP_GAMMA_BASE   
#define DDP_REG_BASE_DISP_MERGE   DISP_MERGE_BASE   
#define DDP_REG_BASE_DISP_SPLIT0  DISP_SPLIT0_BASE  
#define DDP_REG_BASE_DISP_SPLIT1  DISP_SPLIT1_BASE  
#define DDP_REG_BASE_DISP_UFOE    DISP_UFOE_BASE    
#define DDP_REG_BASE_DSI0         DSI0_BASE         
#define DDP_REG_BASE_DSI1         DSI1_BASE         
#define DDP_REG_BASE_DPI          DPI_BASE          
#define DDP_REG_BASE_DISP_PWM0    DISP_PWM0_BASE    
#define DDP_REG_BASE_DISP_PWM1    DISP_PWM1_BASE    
...
#define DDP_REG_BASE_DISP_OD      DISP_OD_BASE      
#endif

#define DISPSYS_REG_ADDR_MIN 0 
#define DISPSYS_REG_ADDR_MAX 0xffffffffffffffff 
...
#define DISP_REG_CONFIG_C09                                       (DISPSYS_CONFIG2_BASE + 0x40)   
#define DISP_REG_CONFIG_C10                                       (DISPSYS_CONFIG2_BASE + 0x44)   
#define DISP_REG_CONFIG_C11                                       (DISPSYS_CONFIG3_BASE + 0x40)   
#define DISP_REG_CLK_CFG_0_MM_CLK                                   (DISPSYS_CONFIG3_BASE+0x40)  
