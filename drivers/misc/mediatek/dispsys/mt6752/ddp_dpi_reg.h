...
typedef struct
{
    DPI_REG_EN              DPI_EN;           
    DPI_REG_RST   	        DPI_RST;          
    DPI_REG_INTERRUPT       INT_ENABLE;       
    DPI_REG_INTERRUPT       INT_STATUS;       
    DPI_REG_CNTL            CNTL;             
    DPI_REG_OUTPUT_SETTING  OUTPUT_SETTING;   
    DPI_REG_SIZE            SIZE;             
    DPI_REG_DDR_SETTING	    DDR_SETTING;      
	
    UINT32                   TGEN_HWIDTH;       
    DPI_REG_TGEN_HPORCH      TGEN_HPORCH;       
    DPI_REG_TGEN_VWIDTH_LODD TGEN_VWIDTH_LODD;  
    DPI_REG_TGEN_VPORCH_LODD TGEN_VPORCH_LODD;  
    
    DPI_REG_BG_HCNTL    BG_HCNTL;        
    DPI_REG_BG_VCNTL    BG_VCNTL;        
    DPI_REG_BG_COLOR    BG_COLOR;        
    DPI_REG_FIFO_CTL    FIFO_CTL;        
    
    DPI_REG_STATUS      STATUS;          
    DPI_REG_TMODE       TMODE;           
    DPI_REG_CHKSUM      CHKSUM;          
    UINT32              rsv_4C;
    UINT32              DUMMY;           
    UINT32              rsv_54[5];  

    DPI_REG_TGEN_VWIDTH_LEVEN   TGEN_VWIDTH_LEVEN; 
    DPI_REG_TGEN_VPORCH_LEVEN   TGEN_VPORCH_LEVEN; 

    DPI_REG_TGEN_VWIDTH_RODD    TGEN_VWIDTH_RODD;  
    DPI_REG_TGEN_VPORCH_RODD    TGEN_VPORCH_RODD;  
    DPI_REG_TGEN_VWIDTH_REVEN   TGEN_VWIDTH_REVEN; 
    DPI_REG_TGEN_VPORCH_REVEN   TGEN_VPORCH_REVEN; 
    DPI_REG_ESAV_VTIM_LOAD      ESAV_VTIM_LOAD;    
    DPI_REG_ESAV_VTIM_LEVEN     ESAV_VTIM_LEVEN;   
    DPI_REG_ESAV_VTIM_ROAD      ESAV_VTIM_ROAD;    
    DPI_REG_ESAV_VTIM_REVEN     ESAV_VTIM_REVEN;   
	
    DPI_REG_ESAV_FTIM       ESAV_FTIM;       
    DPI_REG_CLPF_SETTING    CLPF_SETTING;    
    DPI_REG_Y_LIMIT         Y_LIMIT;         
    DPI_REG_C_LIMIT         C_LIMIT;         
    DPI_REG_YUV422_SETTING  YUV422_SETTING;  
    DPI_REG_EMBSYNC_SETTING EMBSYNC_SETTING; 
    DPI_REG_ESAV_CODE_SET0  ESAV_CODE_SET0;  
    DPI_REG_ESAV_CODE_SET1  ESAV_CODE_SET1;  
