...
{   
    ...
    if(mt6311_get_chip_id()>=PMIC6311_E1_CID_CODE)
    {
        ...
        ret = mt6311_config_interface(0x18,0x1,0x1,2); 
        
        ret = mt6311_config_interface(0x4,0x2,0x7,3); 
        ret = mt6311_config_interface(0x15,0x1,0x1,5); 
        ...
        ret = mt6311_config_interface(0x88,0x0,0x1,1); 
...
#else
unsigned int g_eint_pmic_mt6311_num = 14; 
#endif
...
void mt6311_int_test(void)
{
    ...
    mt6311_config_interface(0x20,0x0F,0xFF,0); 
    mt6311_set_rg_auxadc_ck_pdn(0);
    mt6311_set_rg_auxadc_1m_ck_pdn(0);
    mt6311_config_interface(0xB5,0xC0,0xFF,0); 
    mt6311_config_interface(0xAE,0x03,0xFF,0); 
    mt6311_config_interface(0xAE,0x00,0xFF,0); 
...
void cpu_low_power_setting(void)
{
        ...
        pmic_config_interface(0x04B4,0x0,0x1,0); 
        pmic_config_interface(0x04C6,0x0,0x1,11); 
        pmic_config_interface(0x04C6,0x1,0x1,10); 
        pmic_config_interface(0x04C6,0x0,0x1,8); 
        pmic_config_interface(0x04DA,0x0,0x1,0); 
        pmic_config_interface(0x04EC,0x0,0x1,11); 
        pmic_config_interface(0x04EC,0x1,0x1,10); 
        pmic_config_interface(0x04EC,0x0,0x1,8); 
...
static DEVICE_ATTR(mt6311_access, 0664, show_mt6311_access, store_mt6311_access); 
...
static DEVICE_ATTR(mt6311_vosel_pin, 0664, show_mt6311_vosel_pin, store_mt6311_vosel_pin); 
