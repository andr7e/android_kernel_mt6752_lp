...
static kal_uint32 charging_hw_init(void *data)
{
    ...
    mt6325_upmu_set_rg_vcdt_mode(0);       
    mt6325_upmu_set_rg_vcdt_hv_en(1);      

    mt6325_upmu_set_rg_usbdl_set(0);       
    mt6325_upmu_set_rg_usbdl_rst(1);       

    mt6325_upmu_set_rg_bc11_bb_ctrl(1);    
    mt6325_upmu_set_rg_bc11_rst(1);        
    
    mt6325_upmu_set_rg_csdac_mode(1);      
    mt6325_upmu_set_rg_vbat_ov_en(1);      
#ifdef HIGH_BATTERY_VOLTAGE_SUPPORT
    mt6325_upmu_set_rg_vbat_ov_vth(0x3);   
#else
    mt6325_upmu_set_rg_vbat_ov_vth(0x2);   
#endif
    mt6325_upmu_set_rg_baton_en(1);        

    
    mt6325_upmu_set_rg_baton_ht_en(0);     
...
static kal_uint32 charging_enable(void *data)
{
    ...
    if(KAL_TRUE == enable)
    {
        ...
        mt6325_upmu_set_rg_pchr_flag_en(1);		       
	...
	{
        mt6325_upmu_set_rg_chrwdt_int_en(0);    
        mt6325_upmu_set_rg_chrwdt_en(0);        
        mt6325_upmu_set_rg_chrwdt_flag_wr(0);   
	    mt6325_upmu_set_rg_csdac_en(0);         
...
static kal_uint32 charging_set_cv_voltage(void *data)
{
    ...
    {
        pmic_config_interface(0xEFE,0x0,0xF,1); 
        pmic_config_interface(0xEF8,0x3,0x3F,0); 
...
static kal_uint32 charging_get_current(void *data)
{
    ...
    pmic_read_interface(MT6325_CHR_CON0,&reg_value,0xF,0);
...
static kal_uint32 charging_set_ta_current_pattern(void *data)
{
	...
	if(increase == KAL_TRUE) {
	    	...
	    	mt6325_upmu_set_rg_cm_cs_vthh(0xa);	
		mt6325_upmu_set_rg_cm_cs_vthl(0xf);	
	        
		
		mt6325_upmu_set_rg_cm_vinc_hprd1(9);	
		mt6325_upmu_set_rg_cm_vinc_hprd2(9);	
		
		
		mt6325_upmu_set_rg_cm_vinc_hprd3(29);	
		mt6325_upmu_set_rg_cm_vinc_hprd4(29);	
		
		
		mt6325_upmu_set_rg_cm_vinc_hprd5(29);	
		mt6325_upmu_set_rg_cm_vinc_hprd6(49);	
		...
		mt6325_upmu_set_rg_cm_vdec_hprd1(9);	
		mt6325_upmu_set_rg_cm_vdec_hprd2(9);	
		
		
		mt6325_upmu_set_rg_cm_vdec_hprd3(29);	
		mt6325_upmu_set_rg_cm_vdec_hprd4(29);	
		
		
		mt6325_upmu_set_rg_cm_vdec_hprd5(29);	
		mt6325_upmu_set_rg_cm_vdec_hprd6(49);	
