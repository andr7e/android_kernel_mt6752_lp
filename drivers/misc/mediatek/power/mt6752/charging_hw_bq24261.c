...
static kal_uint32 charging_hw_init(void *data)
{
    ...
    bq24261_config_interface(bq24261_CON0, 0x1, 0x1, 7); 
    bq24261_config_interface(bq24261_CON0, 0x0, 0x1, 6); 
    bq24261_config_interface(bq24261_CON6, 0x3, 0x3, 5); 
    ...
    bq24261_config_interface(bq24261_CON4, 0x2, 0x7, 0); 
    
    
    
    
    bq24261_config_interface(bq24261_CON6, 0x0, 0x1, 0); 
    bq24261_config_interface(bq24261_CON5, 0x3, 0x7, 0); 
    
    bq24261_config_interface(bq24261_CON6, 0x0, 0x1, 3); 
...
static kal_uint32 charging_dump_register_htc(void *data)
 {
	...
	len = bq24261_dump_register_htc(buf, size);
	pReg_dump->size = len;
	return STATUS_OK;
 }
...
static kal_uint32 charging_get_current(void *data)
{
    ...
    bq24261_read_interface(bq24261_CON4, &reg_value, 0x1F, 3); 
...
static kal_uint32 charging_set_ta_current_pattern(void *data)
{
    ...
    {
        charging_set_cv_voltage(&cv_voltage);  
        bq24261_set_ichg(0x0);  
        bq24261_set_dis_ce(0x0);  
    }

    if(increase == KAL_TRUE)
    {
        bq24261_set_in_limit(0x0); 
        msleep(85);
        
        bq24261_set_in_limit(0x2); 
