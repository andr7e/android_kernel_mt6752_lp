...
{       
    unsigned int val = get_devinfo_with_index(28) & 0xFF000000; 
    return (val >> 24);
}

unsigned int __chip_date_code(void)
{
    unsigned int val = get_devinfo_with_index(28) & 0x00FFC000; 
    return (val >> 14);
}    

unsigned int __chip_proj_code(void)
{
    unsigned int val = get_devinfo_with_index(28) & 0x00003FFF; 
    return (val);
}

unsigned int __chip_fab_code(void)
{
    unsigned int val = get_devinfo_with_index(29) & 0x00000007; 
    return (val);
}
