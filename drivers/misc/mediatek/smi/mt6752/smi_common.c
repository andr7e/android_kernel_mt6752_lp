...
#define SF_HWC_PIXEL_MAX_VR   (1920 * 1080 * 4 + 1036800) 
...
static unsigned long gLarbBaseAddr[SMI_LARB_NR] = { 0, 0, 0, 0, 0 };
...
static void restSetting( void ){
    ...
    M4U_WriteReg32(LARB0_BASE, 0x200, 0x1); 
    M4U_WriteReg32(LARB0_BASE, 0x204, 0x1); 
    ...
    M4U_WriteReg32(LARB0_BASE, 0x238, 0x1); 
    M4U_WriteReg32(LARB0_BASE, 0x23c, 0x1); 
    M4U_WriteReg32(LARB0_BASE, 0x240, 0x1); 
    ...
    M4U_WriteReg32(LARB3_BASE, 0x200, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x204, 0x2); 
    M4U_WriteReg32(LARB3_BASE, 0x208, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x20c, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x210, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x214, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x218, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x21c, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x220, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x224, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x228, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x22c, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x230, 0x1); 


    M4U_WriteReg32(LARB4_BASE, 0x200, 0x1); 
    M4U_WriteReg32(LARB4_BASE, 0x204, 0x1); 
    M4U_WriteReg32(LARB4_BASE, 0x208, 0x1); 
    M4U_WriteReg32(LARB4_BASE, 0x20c, 0x1); 
}
static void initSetting( void ){
    ...
    M4U_WriteReg32(LARB0_BASE, 0x20, 0x0); 
    M4U_WriteReg32(LARB1_BASE, 0x20, 0x2); 
    M4U_WriteReg32(LARB2_BASE, 0x20, 0x0); 
    M4U_WriteReg32(LARB3_BASE, 0x20, 0x1); 
    M4U_WriteReg32(LARB4_BASE, 0x20, 0x2); 
    ...
    M4U_WriteReg32(LARB0_BASE, 0x200, 31); 
    M4U_WriteReg32(LARB0_BASE, 0x204, 4); 
    M4U_WriteReg32(LARB0_BASE, 0x208, 6); 
    M4U_WriteReg32(LARB0_BASE, 0x20c, 31); 
    M4U_WriteReg32(LARB0_BASE, 0x210, 4); 
    M4U_WriteReg32(LARB0_BASE, 0x214, 0x1); 

    
    M4U_WriteReg32(LARB0_BASE, 0x238, 2); 
    M4U_WriteReg32(LARB0_BASE, 0x23c, 0x1); 
    M4U_WriteReg32(LARB0_BASE, 0x240, 3); 
...
static void icfpSetting( void ){
    ...
    M4U_WriteReg32(LARB0_BASE, 0x200, 0x1F); 
    M4U_WriteReg32(LARB0_BASE, 0x204, 4); 
    M4U_WriteReg32(LARB0_BASE, 0x208, 6); 
    M4U_WriteReg32(LARB0_BASE, 0x20C, 0x1F); 
    M4U_WriteReg32(LARB0_BASE, 0x210, 4); 
    M4U_WriteReg32(LARB0_BASE, 0x214, 0x1); 
    ...
    M4U_WriteReg32(LARB2_BASE, 0x200, 0xA); 
    M4U_WriteReg32(LARB2_BASE, 0x204, 0x4); 
    M4U_WriteReg32(LARB2_BASE, 0x228, 0x2); 
...
static void vpSetting( void ){
    ...
    M4U_WriteReg32(LARB0_BASE, 0x200, 0x12); 
    M4U_WriteReg32(LARB0_BASE, 0x204, 4); 
    M4U_WriteReg32(LARB0_BASE, 0x208, 6); 
    M4U_WriteReg32(LARB0_BASE, 0x20C, 0x12); 
    M4U_WriteReg32(LARB0_BASE, 0x210, 4); 
    M4U_WriteReg32(LARB0_BASE, 0x238, 2); 
    M4U_WriteReg32(LARB0_BASE, 0x23c, 0x2); 
    M4U_WriteReg32(LARB0_BASE, 0x240, 0x3); 

    M4U_WriteReg32(LARB1_BASE, 0x200, 0x8); 
    ...
    M4U_WriteReg32(LARB1_BASE, 0x214, 0x1); 
    M4U_WriteReg32(LARB1_BASE, 0x218, 0x1); 
    M4U_WriteReg32(LARB1_BASE, 0x21c, 0x1); 
    M4U_WriteReg32(LARB1_BASE, 0x220, 0x1); 
...
static void vpWfdSetting( void ){
    ...
    M4U_WriteReg32(LARB0_BASE, 0x208, 6); 
    M4U_WriteReg32(LARB0_BASE, 0x20C, 0x12); 
    M4U_WriteReg32(LARB0_BASE, 0x210, 0x4); 
    M4U_WriteReg32(LARB0_BASE, 0x238, 2); 
    M4U_WriteReg32(LARB0_BASE, 0x23c, 0x2); 
    M4U_WriteReg32(LARB0_BASE, 0x240, 0x3); 
...
static void smi_dumpCommonDebugMsg( void ){
    ...
    SMIMSG("[0x40c,0x410]=[0x%x,0x%x]\n",
        M4U_ReadReg32(u4Base, 0x40c), M4U_ReadReg32(u4Base, 0x410));
...
int smi_debug_bus_ovl_request_done_check(int ovl_num){
    unsigned int offset = 0x280;
    unsigned long u4_base = get_larb_base_addr(0);
    ...
    reg_value = M4U_ReadReg32(u4_base, offset);
    if(reg_value ==0){
        return 1;
    }else{
        return 0;
...
int smi_debug_bus_hanging_detect( unsigned int larbs, int show_dump ){
    ...
    for( dump_time = 0; dump_time < 5; dump_time++ ){
        ...
        reg_temp = M4U_ReadReg32(SMI_COMMON_EXT_BASE, 0x408);
        if( (reg_temp & (1 << 10)) == 0 ){
    ...
    for( i = 0; i < SMI_LARB_NR; i++ ){ 
        if( SMI_DGB_LARB_SELECT(larbs, i) ){
            ...
            if( smi_larb_busy_count[i] == 5 ){ 
                if( smi_common_busy_count == 5 ){ 
                    status_code = 1;
            ...
            }else if( smi_larb_busy_count[i] == 0 ){ 
                if( smi_common_busy_count == 5 ){ 
                    status_code = 3;
                }else if( smi_common_busy_count == 0 ){ 
                    status_code = 4;
