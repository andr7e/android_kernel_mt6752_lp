...
static unsigned int over_up_time = 0; 
static unsigned int up_duration = 30; 
static unsigned int up_step = 1; 

static unsigned int below_low_time = 0; 
static unsigned int low_duration = 10; 
static unsigned int low_step = 1; 
...
static int amdtxpwr_backoff(int level)
{
    ...
    if (level == 0) 
    {
        ...
        ret = eemcs_notify_md_by_sys_msg(MD_SYS5, EXT_MD_TX_PWR_REDU_REQ, 23); 
