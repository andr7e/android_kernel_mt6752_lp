...
{{ 2624, 1956,      8,    2, 2608, 1952, 1296,  972, 0000, 0000, 1296,  972,      2,    2, 1280,  960}, 
 ...
 { 2624, 1956,      2,  250, 2608, 1460, 1280,  720, 0000, 0000, 1280,  720,      0,    0, 1280,  720}, 
...
write_cmos_sensor(0x0801, 0x2F);  
write_cmos_sensor(0x0802, 0x18);  
write_cmos_sensor(0x0803, 0x3f);  
write_cmos_sensor(0x0804, 0x3c);  
write_cmos_sensor(0x0805, 0x2f);  
write_cmos_sensor(0x0806, 0xc0);  
write_cmos_sensor(0x0807, 0x2F);  
