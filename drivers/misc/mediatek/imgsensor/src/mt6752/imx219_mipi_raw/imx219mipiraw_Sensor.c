...
{{ 3280, 2464,	0, 	0, 3280, 2464, 1640, 1232, 0, 0, 1640, 1232,		2,	2, 1632,  1224}, 
 { 3280, 2464,	0,	0, 3280, 2464, 3280, 2464, 0, 0, 3280, 2464,	4,	4, 3264, 2448}, 
 { 3280, 2464,	0,	0, 3280, 2464, 3280, 2464, 0, 0, 3280, 2464,	4,	4, 3264, 2448},  
 { 3280, 2464,	0,  0, 3280, 2464, 1920, 1080, 0, 0, 1920, 1080,	0,	0, 1920, 1080}, 
 { 3280, 2464,	0,  0, 3280, 2464, 1640,  926, 0, 0, 1640,  926,	0,	0, 1280,  720}};
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    iTemp = read_cmos_sensor(0x0172) & 0x03;	
    switch (image_mirror)
    {
        case IMAGE_NORMAL:
            ...
            break;
        case IMAGE_V_MIRROR:
            write_cmos_sensor(0x0172, iTemp | 0x01);	
            break;
        case IMAGE_H_MIRROR:
            write_cmos_sensor(0x0172, iTemp | 0x02);	
            break;
        case IMAGE_HV_MIRROR:
            write_cmos_sensor(0x0172, 0x00);	
            break;
    }
	...
	if(imgsensor.current_scenario_id != MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG)
	   {
		   ...
		   {   
			   ...
			   write_cmos_sensor(0x0624, 0x06); 
			   write_cmos_sensor(0x0625, 0x68); 
			   write_cmos_sensor(0x0626, 0x04); 
			   write_cmos_sensor(0x0627, 0xd0); 
	   ...
	   else
	   {
		   ...
		   {   
			   ...
			   write_cmos_sensor(0x0600, 0x00); 
			   write_cmos_sensor(0x0601, 0x02); 	 
			   write_cmos_sensor(0x0624, 0x0C); 
			   write_cmos_sensor(0x0625, 0xD0); 
			   write_cmos_sensor(0x0626, 0x09); 
			   write_cmos_sensor(0x0627, 0xA0); 
			   write_cmos_sensor(0x6128, 0x00); 
			   write_cmos_sensor(0x6129, 0x02); 		 
