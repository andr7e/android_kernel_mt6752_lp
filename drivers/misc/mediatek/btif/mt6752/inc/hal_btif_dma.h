...
#define TX_DMA_INT_FLAG(base)           (unsigned long)(base + 0x0)	
#define TX_DMA_INT_EN(base)             (unsigned long)(base + 0x4)	
#define TX_DMA_EN(base)                 (unsigned long)(base + DMA_EN_OFFSET)	
#define TX_DMA_RST(base)                (unsigned long)(base + DMA_RST_OFFSET)	
#define TX_DMA_STOP(base)               (unsigned long)(base + DMA_STOP_OFFSET)	
#define TX_DMA_FLUSH(base)              (unsigned long)(base + DMA_FLUSH_OFFSET)	
#define TX_DMA_VFF_ADDR(base)           (unsigned long)(base + 0x1C)	
#define TX_DMA_VFF_LEN(base)            (unsigned long)(base + 0x24)	
#define TX_DMA_VFF_THRE(base)           (unsigned long)(base + 0x28)	
#define TX_DMA_VFF_WPT(base)            (unsigned long)(base + 0x2C)	
#define TX_DMA_VFF_RPT(base)            (unsigned long)(base + 0x30)	
#define TX_DMA_W_INT_BUF_SIZE(base)     (unsigned long)(base + 0x34)	
#define TX_DMA_INT_BUF_SIZE(base)       (unsigned long)(base + 0x38)	
#define TX_DMA_VFF_VALID_SIZE(base)     (unsigned long)(base + 0x3C)	
#define TX_DMA_VFF_LEFT_SIZE(base)      (unsigned long)(base + 0x40)	
#define TX_DMA_DEBUG_STATUS(base)       (unsigned long)(base + 0x50)	

#define RX_DMA_INT_FLAG(base)           (unsigned long)(base + 0x0)	
#define RX_DMA_INT_EN(base)             (unsigned long)(base + 0x4)	
#define RX_DMA_EN(base)                 (unsigned long)(base + DMA_EN_OFFSET)	
#define RX_DMA_RST(base)                (unsigned long)(base + DMA_RST_OFFSET)	
#define RX_DMA_STOP(base)               (unsigned long)(base + DMA_STOP_OFFSET)	
#define RX_DMA_FLUSH(base)              (unsigned long)(base + DMA_FLUSH_OFFSET)	
#define RX_DMA_VFF_ADDR(base)           (unsigned long)(base + 0x1C)	
#define RX_DMA_VFF_LEN(base)            (unsigned long)(base + 0x24)	
#define RX_DMA_VFF_THRE(base)           (unsigned long)(base + 0x28)	
#define RX_DMA_VFF_WPT(base)            (unsigned long)(base + 0x2C)	
#define RX_DMA_VFF_RPT(base)            (unsigned long)(base + 0x30)	
#define RX_DMA_FLOW_CTRL_THRE(base)     (unsigned long)(base + 0x34)	
#define RX_DMA_INT_BUF_SIZE(base)       (unsigned long)(base + 0x38)	
#define RX_DMA_VFF_VALID_SIZE(base)     (unsigned long)(base + 0x3C)	
#define RX_DMA_VFF_LEFT_SIZE(base)      (unsigned long)(base + 0x40)	
#define RX_DMA_DEBUG_STATUS(base)       (unsigned long)(base + 0x50)	
