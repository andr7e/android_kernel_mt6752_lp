...
#define KBASE_PHY_PAGES_FLAG_DEFAULT (0)	
#define KBASE_PHY_PAGES_FLAG_CLEAR   (1 << 0)	
#define KBASE_PHY_PAGES_FLAG_POISON  (1 << 1)	
...
#define KBASE_PHY_PAGES_POISON_VALUE  0xFD 
