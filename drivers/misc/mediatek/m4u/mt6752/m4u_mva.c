...
#define MVA_BLOCK_SIZE_ORDER     20     
#define MVA_MAX_BLOCK_NR        4095    

#define MVA_BLOCK_SIZE      (1<<MVA_BLOCK_SIZE_ORDER)  
#define MVA_BLOCK_ALIGN_MASK (MVA_BLOCK_SIZE-1)        
#define MVA_BLOCK_NR_MASK   (MVA_MAX_BLOCK_NR)      
#define MVA_BUSY_MASK       (1<<15)                 
