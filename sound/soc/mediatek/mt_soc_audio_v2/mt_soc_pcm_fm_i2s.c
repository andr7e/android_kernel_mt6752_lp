...
static struct wake_lock fm_playback_wakelock;
...
static int mtk_pcm_fm_i2s_open(struct snd_pcm_substream *substream)
{
    ...
    wake_lock(&fm_playback_wakelock);
...
static int mtk_pcm_fm_i2s_close(struct snd_pcm_substream *substream)
{
    ...
    wake_unlock(&fm_playback_wakelock);
...
static int __init mtk_fm_i2s_soc_platform_init(void)
{
    ...
    #endif
    wake_lock_init(&fm_playback_wakelock, WAKE_LOCK_SUSPEND, "fm_playback");
    printk("init fm_playback_wakelock\n");
