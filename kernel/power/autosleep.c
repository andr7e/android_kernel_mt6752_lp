...
#ifdef CONFIG_HTC_POWER_PROFILING_6752
               pr_info("[P][R] suspend abort, wakeup event nonzero\n");
...
#ifdef CONFIG_HTC_POWER_PROFILING_6752
                pr_info("[P][R] suspend abort, events not matched or being processed\n");
#endif
...
int pm_autosleep_set_state(suspend_state_t state)
{
	...
	mutex_unlock(&autosleep_lock);
       ...
       sysfs_notify(power_kobj, NULL, "autosleep");
#endif
	return 0;
}
